...
(custom-set-variables
 ...
 '(company-backends
   (quote
    (company-bbdb company-eclim company-semantic company-clang company-xcode company-cmake company-capf company-files
                  ...
                  company-oddmuse company-dabbrev company-shell)))
 ...
 '(exec-path
   (quote
    ("/usr/local/bin" "/usr/bin" "/usr/lib/emacs/26.3/x86_64-pc-linux-gnu" "~/.nimble/bin")))
 ...
 '(package-selected-packages
   (quote
    (company-shell company nlinum-hl nlinum abyss-theme haskell-mode default-text-scale cider))))
